...
temp_training_response=[max_response(1,:), max_response(2,:), max_response(3,:), max_response(4,:), max_response(5,:)]
c=0;
...
%%%%testing%%%%%
for i = 1% [1,2,3,7,8,15,17,19,21,22]%:20%:numel(d)
...
%   load max_response.mat;
%   
%   temp_training_response=[max_response(1,1:3), max_response(2,4:6), max_response(3,7:9), max_response(4,10:12), max_response(4,13:15)]
% 
%   test_max_response(1,:) >= 0.66*temp_training_response
%   
%  
% %  test_res= test_max_response(3,:)>=z
% %  test_result_thrs = test_max_response(3,:)>=0.7*z
% 
% 
% 
% 
