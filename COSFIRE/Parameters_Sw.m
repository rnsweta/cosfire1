...
params.invariance.rotation.psilist    = 0:pi/4:(2*pi)-pi/4;%0;
...
params.inputfilter.Gabor.phaseoffset        = pi; %symmetric Gabor filter. Suitable to detect lines
